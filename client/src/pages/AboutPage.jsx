    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <div className="bg-neutral-900 p-8 rounded-lg">
            <h3 className="text-xl font-semibold mb-4 text-green-400">Vision</h3>
          ...
          <div className="bg-neutral-900 p-8 rounded-lg">
            <h3 className="text-xl font-semibold mb-4 text-orange-400">Mission</h3>
            <p className="text-neutral-300">
      ...
      <div className="bg-neutral-950 py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h3 className="text-xl font-semibold mb-6 text-center">Our Specialization: Delta InfraSuite Solutions</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-neutral-900 p-6 rounded-lg text-center">
              <Zap className="h-12 w-12 text-green-400 mx-auto mb-4" />
              <h4 className="font-semibold mb-2">Power Management (UPS)</h4>
            ...
            <div className="bg-neutral-900 p-6 rounded-lg text-center">
              ...
              <h4 className="font-semibold mb-2">Precision Cooling</h4>
            ...
            <div className="bg-neutral-900 p-6 rounded-lg text-center">
              ...
              <h4 className="font-semibold mb-2">Racks & Accessories</h4>
      ...
      {/* Core Values Section */}
      <div className="max-w-7xl mx-auto px-6 py-20">
        <h2 className="text-2xl sm:text-3xl text-center mb-10">Our Core Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Modular Scalability</h3>
            <p className="text-neutral-400">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Mission-Critical Reliability</h3>
            <p className="text-neutral-400">
      ...
      <div className="bg-neutral-950 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-2xl sm:text-3xl text-center mb-10">Markets & Applications</h2>
