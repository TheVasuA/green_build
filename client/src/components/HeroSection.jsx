...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center ">
       <div className="flex relative justify-center max-w-8xl mx-auto blur-[1px] object-cover opacity-40">

        <video
          autoPlay
          loop
          muted
          className=" border border-secondary-500 shadow-lg shadow-secondary-200 "
        >
